    ...
    <section className="relative overflow-hidden px-5 pt-40 pb-16 md:px-10 md:pt-48 md:pb-24">
      <div className="mx-auto grid max-w-[1440px] items-end gap-12 lg:grid-cols-12">
        <div className="lg:col-span-6">
          <p className="reveal text-[11px] tracking-[0.28em] uppercase text-[var(--plum)]">
          ...
          <p className="reveal mt-4 font-serif italic text-[28px] leading-none text-[var(--plum)] md:text-[36px]">
            {company.tagline}
          </p>
          ...
          <div className="reveal mt-10 flex flex-wrap items-center gap-4">
            <Link
              href="/contact"
              className="inline-flex items-center rounded-full bg-[var(--ink)] px-7 py-3.5 text-[11px] font-medium tracking-[0.18em] uppercase text-white transition-colors hover:bg-[var(--plum)]"
            >
              Start a Project
            </Link>
            <Link
